...
@RestController
@RequestMapping("/api/dt-cloud-kafka")
public class DtCloudKafkaResource {
    private final Logger log = LoggerFactory.getLogger(DtCloudKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public DtCloudKafkaResource(KafkaProperties kafkaProperties) {
